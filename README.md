About api_dock-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/api_dock-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/SchmidtDSE/api_dock
...
Development: https://github.com/SchmidtDSE/api_dock
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-api__dock-green.svg)](https://anaconda.org/conda-forge/api_dock) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/api_dock.svg)](https://anaconda.org/conda-forge/api_dock) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/api_dock.svg)](https://anaconda.org/conda-forge/api_dock) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/api_dock.svg)](https://anaconda.org/conda-forge/api_dock) |

Installing api_dock
===================

Installing `api_dock` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
mamba repoquery search api_dock --channel conda-forge

# List packages depending on `api_dock`:
mamba repoquery whoneeds api_dock --channel conda-forge
...
Updating api_dock-feedstock
===========================

If you would like to improve the api_dock recipe or build a new
...
Note that all branches in the conda-forge/api_dock-feedstock are
